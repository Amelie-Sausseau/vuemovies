<template>
  <div class="container">
    <h1>Les films sortis en 2023</h1>
...
export default {
  ...
  created: function () {
    axios
      .get('https://api.themoviedb.org/3/discover/movie?api_key=34631a980651e8bff8493b4e3578c661&language=fr-FR&sort_by=release_date.asc&include_adult=false&include_video=false&page=1&primary_release_year=2023&vote_count.gte=100')
      .then(res => {
